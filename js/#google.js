  function $(id) {
      ...
      var mapOptions = {
        center: new google.maps.LatLng(55.032357,83.026568),
        zoom: 15,
		...
		for(var i=0; i<houses.length; i++)
	    {
           ...
           var color = "#ffaaaa";
            ...
            ({
			 ...
			 var caption = '<b>' + house[0] + "</b><br><a href='http://diskus-telecom.ru/component/artforms/?formid=1'>Оставить заявку на подключение</a>";
